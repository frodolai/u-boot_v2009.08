 ...
 *
 * Configuration settings for the MX6Q AR6MX Freescale board.
 *
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
	...
	"bootargs_base=setenv bootargs console=ttymxc3,115200 root=/dev/mmcblk0p1 rootwait rw enable_wait_mode=off\0"	\
...
#define CONFIG_SYS_PROMPT		"AR6MX U-Boot > "
