...
/* TODO: Do we really need I2C in bootloader? */
//-oliver #define CONFIG_CMD_I2C
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"rootwait rw video=mxcfb0:dev=ldb,1024x600M@60,if=RGB666,bpp=32 nosmp enable_wait_mode=off\0"		\
