 ...
 *
 * Configuration settings for the MX6Solo AR6MX Freescale board.
 *
...
#define CONFIG_MX6Q_IM300B
#define CONFIG_FLASH_HEADER
#define CONFIG_FLASH_HEADER_OFFSET 0x400
#define CONFIG_MX6_CLK32	   32768
//#define CONFIG_BOARD_VER_GPIO
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
	...
	"bootargs_base=setenv bootargs console=ttymxc3,115200 root=/dev/mmcblk0p1 rootwait rw nosmp\0"	\
	"bootargs_lcd=setenv bootargs ${bootargs} video=mxcfb0:dev=lcd,INNOLUX_WVGA,if=RGB24,bpp=32\0"						\
	"bootcmd_lcd=run bootargs_base bootargs_lcd;mmc dev 1;mmc read ${loadaddr} 0x800 0x2000;bootm\0" \
...
#define CONFIG_SYS_PROMPT		"iM300B U-Boot > "
...
#define CONFIG_CMD_DHCP
#define CONFIG_CMD_PING
#define CONFIG_IPADDR				192.168.111.250
#define CONFIG_SERVERIP			192.168.111.14
