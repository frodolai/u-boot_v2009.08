...
#ifndef MX6Q_AR6MX_ANDROID_H
#define MX6Q_AR6MX_ANDROID_H

#include <asm/arch/mx6.h>
#include "mx6q_ar6mx.h"
...
#define CONFIG_FASTBOOT_PRODUCT_NAME_STR "i.mx6solo AR6MX"
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"bootargs=console=ttymxc3,115200 init=/init "	\
			"video=mxcfb0:dev=hdmi,1920x1080M@60,if=RGB24,bpp=32 "	\
			"video=mxcfb1:off video=mxcfb2:off "	\
			"androidboot.console=ttymxc3 enable_wait_mode=off "	\
